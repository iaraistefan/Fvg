...
class FVGBot:
    ...
    def scan_symbol(self, symbol: str):
        ...
        # Verifica local (fara API call) — mai rapid si fara rate limit
    ...
    def run_cycle(self):
        ...
        for sym in symbols:
            ...
            try:
                ...
                if e.code == -1003:
                    logger.warning("Rate limit / ban — astept 60s...")
                    time.sleep(60)
                    break
                else:
    ...
    def run(self):
        # Offset 30s fata de botul 1H — evita scanare simultana pe acelasi IP
